...
<Warning>
**Preview.** The Cartesia engine is currently in private rollout — `type: "cartesia"` is not yet accepted by the public production API. Contact [support@avaturn.me](mailto:support@avaturn.me) to enable it for your project.
</Warning>
